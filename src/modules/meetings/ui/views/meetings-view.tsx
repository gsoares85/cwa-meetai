...
import {meetingsColumns} from "@/modules/meetings/ui/components/columns";
...
export const MeetingsView = () => {
    ...
    return (
        <div className="flex-1 pb-4 px-4 md:px-8 flex flex-col gap-y-4">
            <DataTable columns={meetingsColumns} data={data.items} />
            {data.items.length === 0 && (
                <EmptyState title="Create your first meeting" description="Create a meeting to connect with others.
